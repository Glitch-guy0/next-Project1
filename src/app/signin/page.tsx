      ...
      <div className="bg-slate-100 shadow-lg p-3 rounded-lg max-w-[360px] w-2/3">
        ...
        <form action="" className="flex flex-col gap-4  mt-4">
          <input
            ...
            className="outline-none p-2 rounded-lg outline-2 focus:outline-blue-400" 
          />
          <input
            type="email"
            name=""
            id=""
            placeholder="Email"
            className="peer/email outline-none p-2 rounded-lg outline-2 focus:outline-blue-400 invalid:text-rose-400 invalid:outline-rose-400" 
          />
          {/* error for email */}
          ...
          <input
            ...
            pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).{8,}$"
            className="peer/password outline-none p-2 rounded-lg outline-2 focus:outline-blue-400 invalid:text-rose-400 invalid:outline-rose-400" 
            />
          {/* error for password */}
